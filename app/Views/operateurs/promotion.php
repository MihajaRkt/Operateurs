...
<body class="op-body">
    ...
    <div class="d-flex">
        ...
        <main class="op-main p-3 p-lg-4">
            <h1 class="op-page-title h3 mb-4">Configuration de prommotion</h1>
            ...
            <?php if (!empty($promotion)) : ?>
                <div class="op-card p-3 p-lg-4 mb-4" style="max-width: 480px;">
                    <form action="/voirCommission" method="post" class="row g-3 align-items-end">
                        <div class="col-12">
                            <label for="pourcentage" class="form-label">Promotion (%)</label>
                            <input type="number"
                                   class="form-control"
                                   id="pourcentage"
                                   name="pourcentage"
            ...
            <?php else: ?>
                <div class="op-card p-3 p-lg-4 mb-4" style="max-width: 480px;">
                    <form action="/voirCommission" method="post" class="row g-3 align-items-end">
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-op-primary">
                                <i class="bi bi-plus-lg"></i> Créer la Promotion
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="op-card p-3 p-lg-4">
                <h2 class="h5 mb-3">Promotion actuelle de <?= esc($user['nom'] ?? '') ?></h2>
