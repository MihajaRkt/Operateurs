...
<head>
    <?= view('clients/partials/head', ['opTitle' => 'Faire un retrait']) ?>
</head>
...
<body class="op-body">
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="clSidebarOffcanvas">
        ...
        <div class="offcanvas-body p-0">
            <?= view('clients/partials/sidebar', ['opActive' => 'retrait']) ?>
        </div>
    </div>
    ...
    <div class="d-flex">
        ...
        <main class="op-main p-3 p-lg-4">
            <h1 class="op-page-title h3 mb-4">Faire un retrait</h1>
            ...
            <div class="op-card p-3 p-lg-4" style="max-width: 480px;">
                ...
                <form action="/retrait/save" method="post" class="op-needs-validation" novalidate>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-op-primary">
                        <i class="bi bi-wallet2"></i> Retirer
                    </button>
                </form>
            </div>
        </main>
